...
export class ResponseUtil {
   ...
   * 401 Unauthorized
   */
  static unauthorized(res: Response, message: string = "Unauthorized", details?: any): void {
   ...
   * 403 Forbidden
   */
  static forbidden(res: Response, message: string = "Forbidden", details?: any): void {
   ...
   * 404 Not Found
   */
  static notFound(res: Response, message: string = "Resource not found", details?: any): void {
   ...
   */
  static validationError(res: Response, message: string = "Validation failed", details?: any): void {
